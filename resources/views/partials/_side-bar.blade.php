...
<section class="side-content">
    <div class="about_me">
        <div class="about_me_inner d_flex">
            <div class="avtar">
                <img src="{{ asset('/frontend/img/me.png')}}" alt="my_avtar">
            </div>
    ...
    <div class="follow_insta">
        ...
        <div class="photo_grid d_flex">
            ...
            <img src="{{ asset('/frontend/img/photo_grid/8.jpg')}}" alt="grid_image">
            <img src="{{ asset('/frontend/img/photo_grid/9.jpg')}}" alt="grid_image">
        </div>
    </div>
    ...
    <div class="banner">
        ...
        <div class="banner_img">
            <img src="{{ asset('/frontend/img/banner.jpg')}}" alt="banner_img">
        </div>
    </div>
